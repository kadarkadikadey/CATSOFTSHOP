...
This repository contains the full source code for the CatSoftShop ecosystem:
...
### Prerequisites
* [Node.js](https://nodejs.org/) (for Server and WebApp)
* [Flutter](https://flutter.dev/) or [React Native](https://reactnative.dev/) (depending on your MOBILAPP framework)
